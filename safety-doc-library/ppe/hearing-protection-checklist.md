...
|---|---|:--:|:--:|:--:|---|
| 1 | Noise level warrants protection (raise voice at arm's length = protect) |  |  |  |  |
| 2 | Protection rated adequately for the noise |  |  |  |  |
| 3 | Earplugs inserted correctly / muffs seal fully |  |  |  |  |
| 4 | Double protection used for very high noise |  |  |  |  |
| 5 | Plugs/muffs clean and in good condition |  |  |  |  |
| 6 | Exposure time managed/rotated where possible |  |  |  |  |
| 7 | Workers can still hear needed alarms/communication |  |  |  |  |
...
<sub>Template ID: `hearing-protection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
