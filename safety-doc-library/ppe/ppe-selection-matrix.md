...
## Matrix
Map each task/area to its hazards and the PPE required. Build this from your PPE Hazard Assessment.
...
<sub>Template ID: `ppe-selection-matrix` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
