...
|---|---|:--:|:--:|:--:|---|
| 1 | Safety-toe footwear where crush/impact hazards exist |  |  |  |  |
| 2 | Puncture-resistant soles where nails/debris present |  |  |  |  |
| 3 | Slip-resistant soles for wet/sloped surfaces |  |  |  |  |
| 4 | Electrical-hazard rated footwear where needed |  |  |  |  |
| 5 | Metatarsal guards for heavy material handling (if applicable) |  |  |  |  |
| 6 | Footwear in good condition — soles not worn through |  |  |  |  |
| 7 | Laces tied; proper fit |  |  |  |  |
...
<sub>Template ID: `foot-protection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
