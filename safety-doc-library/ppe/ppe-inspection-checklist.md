...
|---|---|:--:|:--:|:--:|---|
| 1 | Hard hat — no cracks, dents, or heavy UV damage; suspension intact |  |  |  |  |
| 2 | Eye/face protection — no cracks, deep scratches; clear vision |  |  |  |  |
| 3 | Hearing protection — clean, intact, correct fit |  |  |  |  |
| 4 | Gloves — no holes, tears, or contamination; correct type |  |  |  |  |
| 5 | Footwear — soles and toe protection intact |  |  |  |  |
| 6 | High-visibility clothing — clean, visible, not faded |  |  |  |  |
| 7 | Fall protection PPE — see dedicated harness/lanyard checklist |  |  |  |  |
...
<sub>Template ID: `ppe-inspection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
