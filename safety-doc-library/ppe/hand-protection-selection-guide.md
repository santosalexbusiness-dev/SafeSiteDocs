...
## Template Body
Use this guide to choose the right glove for the hazard. Match the glove to the task; no single glove fits all.
...
<sub>Template ID: `hand-protection-selection-guide` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
