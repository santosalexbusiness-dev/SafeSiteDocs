...
## Policy
**1. Purpose** — Ensure workers are visible to operators and drivers near traffic and moving equipment.
...
<sub>Template ID: `high-visibility-clothing-policy` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
