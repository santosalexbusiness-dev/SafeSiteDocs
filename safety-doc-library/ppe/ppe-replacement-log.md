...
## Log
Track PPE replaced and why (wear, damage, expiration).
...
<sub>Template ID: `ppe-replacement-log` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
