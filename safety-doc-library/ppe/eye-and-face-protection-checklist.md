...
|---|---|:--:|:--:|:--:|---|
| 1 | Correct protection for the hazard (impact, dust, splash, radiation) |  |  |  |  |
| 2 | Safety glasses have side protection |  |  |  |  |
| 3 | Goggles used for dust or chemical splash |  |  |  |  |
| 4 | Face shield worn over glasses/goggles for grinding/cutting/chemicals |  |  |  |  |
| 5 | Lenses clean, not cracked or deeply scratched |  |  |  |  |
| 6 | Proper fit; no gaps |  |  |  |  |
| 7 | Eyewash station identified and functional (for chemical work) |  |  |  |  |
...
<sub>Template ID: `eye-and-face-protection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
