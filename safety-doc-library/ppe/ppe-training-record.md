...
## Template Body
Document PPE training for each employee.
...
<sub>Template ID: `ppe-training-record` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
