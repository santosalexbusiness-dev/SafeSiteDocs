...
|---|---|:--:|:--:|:--:|---|
| 1 | Hard hat worn where falling/flying/fixed-object or electrical hazards exist |  |  |  |  |
| 2 | Correct type/class for the hazard (incl. electrical) |  |  |  |  |
| 3 | Shell free of cracks, dents, and heavy UV/chalking |  |  |  |  |
| 4 | Suspension intact and adjusted for a snug fit |  |  |  |  |
| 5 | Within manufacturer's service life |  |  |  |  |
| 6 | Not stored in direct sun/heat (e.g., dashboard) |  |  |  |  |
| 7 | Accessories (face shield, earmuffs) compatible and secure |  |  |  |  |
...
<sub>Template ID: `head-protection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
