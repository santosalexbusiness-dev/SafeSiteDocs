...
|---|---|:--:|:--:|:--:|---|
| 1 | Muster point identified, safe distance from hazards, and known to all |  |  |  |  |
| 2 | Clear evacuation routes to the muster point |  |  |  |  |
| 3 | Headcount/roster method established per crew |  |  |  |  |
| 4 | Process to report missing persons to responders |  |  |  |  |
| 5 | Alternate muster point identified |  |  |  |  |
| 6 | Muster point marked/communicated at orientation |  |  |  |  |
| 7 | Re-entry only after the all-clear |  |  |  |  |
...
<sub>Template ID: `muster-point-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
