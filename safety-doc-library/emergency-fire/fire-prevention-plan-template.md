...
## Plan
**Fire Prevention Plan for [COMPANY NAME] — [SITE].**
...
<sub>Template ID: `fire-prevention-plan-template` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
