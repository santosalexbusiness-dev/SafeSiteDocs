...
## Plan
**Emergency Action Plan for [COMPANY NAME] — [SITE].** Post and review with all workers.
...
<sub>Template ID: `emergency-action-plan-template` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
