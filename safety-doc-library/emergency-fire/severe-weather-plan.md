...
## Plan
**Severe Weather Plan for [COMPANY NAME] — [SITE].**
...
<sub>Template ID: `severe-weather-plan` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
