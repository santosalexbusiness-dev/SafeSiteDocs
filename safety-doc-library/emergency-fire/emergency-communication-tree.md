...
## Template Body
Define who calls whom in an emergency so information flows fast.
...
<sub>Template ID: `emergency-communication-tree` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
