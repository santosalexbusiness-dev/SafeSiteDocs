...
## Log
Track inspection of emergency equipment (extinguishers, first aid, eyewash, AED, alarms).
...
<sub>Template ID: `emergency-equipment-inspection-log` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
