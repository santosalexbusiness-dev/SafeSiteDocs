...
## Plan
**Earthquake Response Plan for [COMPANY NAME] — [SITE].** (Customize for your region's risk.)
...
<sub>Template ID: `earthquake-response-plan` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
