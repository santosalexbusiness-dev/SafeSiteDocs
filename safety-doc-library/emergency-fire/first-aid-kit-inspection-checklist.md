...
|---|---|:--:|:--:|:--:|---|
| 1 | Kit present and accessible at the designated location |  |  |  |  |
| 2 | Contents match the kit list and quantity |  |  |  |  |
| 3 | No expired items |  |  |  |  |
| 4 | Bandages, gauze, tape, antiseptic stocked |  |  |  |  |
| 5 | Gloves and barrier/CPR shield present |  |  |  |  |
| 6 | Trauma supplies appropriate to the work (if applicable) |  |  |  |  |
| 7 | Restocked after any use; eyewash available where needed |  |  |  |  |
...
<sub>Template ID: `first-aid-kit-inspection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
