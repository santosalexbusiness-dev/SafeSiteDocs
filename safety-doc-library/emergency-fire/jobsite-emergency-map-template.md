...
## Template Body
Create a simple site map and post it. Mark the items below.
...
<sub>Template ID: `jobsite-emergency-map-template` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
