...
## Procedure
Post where workers can see it. Customize contacts.
...
<sub>Template ID: `medical-emergency-procedure` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
