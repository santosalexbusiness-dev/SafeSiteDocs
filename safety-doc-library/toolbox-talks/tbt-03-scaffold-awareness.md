# Toolbox Talk: Scaffold Awareness
...
<sub>Template ID: `tbt-03-scaffold-awareness` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
