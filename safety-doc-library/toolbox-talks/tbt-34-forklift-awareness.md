# Toolbox Talk: Forklift Awareness
...
<sub>Template ID: `tbt-34-forklift-awareness` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
