# Toolbox Talk: End-of-Year Safety Review
...
## Toolbox Talk
**Topic:** End-of-Year Safety Review
...
<sub>Template ID: `tbt-52-end-of-year-safety-review` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
