# Toolbox Talk: Near Miss Reporting
...
<sub>Template ID: `tbt-40-near-miss-reporting` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
