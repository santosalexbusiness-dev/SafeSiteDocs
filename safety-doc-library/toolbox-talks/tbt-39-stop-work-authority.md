# Toolbox Talk: Stop Work Authority
...
<sub>Template ID: `tbt-39-stop-work-authority` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
