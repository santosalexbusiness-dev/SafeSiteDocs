# Toolbox Talk: Respiratory Protection Awareness
...
Print this talk or pull it up on a phone or tablet. Review the lesson and key hazards with the crew (about five minutes), ask the discussion questions, walk the crew checklist, then collect signatures on the attendance section. File the signed copy with your training records.

---

## Toolbox Talk
**Topic:** Respiratory Protection Awareness
...
<sub>Template ID: `tbt-10-respiratory-protection-awareness` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
