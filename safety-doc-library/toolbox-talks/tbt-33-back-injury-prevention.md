# Toolbox Talk: Back Injury Prevention
...
<sub>Template ID: `tbt-33-back-injury-prevention` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
