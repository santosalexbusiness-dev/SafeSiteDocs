# Toolbox Talk: Electrical Shock Prevention
...
<sub>Template ID: `tbt-18-electrical-shock-prevention` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
