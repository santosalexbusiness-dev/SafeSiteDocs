...
## Template Body
Maintain a current list of employees authorized to drive company vehicles/equipment.
...
<sub>Template ID: `authorized-driver-list` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
