...
|---|---|:--:|:--:|:--:|---|
| 1 | Forks, mast, and chains in good condition |  |  |  |  |
| 2 | Hydraulics operate; no leaks |  |  |  |  |
| 3 | Tires in good condition |  |  |  |  |
| 4 | Brakes, steering, and controls function |  |  |  |  |
| 5 | Horn and lights/backup alarm work |  |  |  |  |
| 6 | Seatbelt present and functional; overhead guard intact |  |  |  |  |
| 7 | Data plate legible; load capacity known; fuel/charge adequate |  |  |  |  |
...
<sub>Template ID: `forklift-daily-inspection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
