...
|---|---|:--:|:--:|:--:|---|
| 1 | One designated spotter assigned |  |  |  |  |
| 2 | Hand signals (including STOP) agreed before moving |  |  |  |  |
| 3 | Spotter stays in the operator's view and out of the path/pinch points |  |  |  |  |
| 4 | High-visibility clothing worn |  |  |  |  |
| 5 | Clearance from overhead/underground hazards confirmed |  |  |  |  |
| 6 | Move stops immediately if visual contact is lost |  |  |  |  |
| 7 | Pedestrians kept clear of the work zone |  |  |  |  |
...
<sub>Template ID: `spotter-safety-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
