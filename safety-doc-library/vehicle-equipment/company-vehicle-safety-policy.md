...
## Policy
**1. Purpose** — Ensure safe operation of company vehicles.

**2. Scope** — All applicable employees and operations of [COMPANY NAME].

**3. Policy Statement** — Drivers operate company vehicles safely, legally, and responsibly.
...
<sub>Template ID: `company-vehicle-safety-policy` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
