...
## Template Body
Daily pre-use inspection for powered equipment. Customize items to the machine.
...
<sub>Template ID: `daily-equipment-inspection-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
