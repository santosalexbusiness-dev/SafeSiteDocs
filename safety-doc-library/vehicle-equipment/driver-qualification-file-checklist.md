...
|---|---|:--:|:--:|:--:|---|
| 1 | Valid driver's license (correct class) on file |  |  |  |  |
| 2 | Motor vehicle record (MVR) reviewed |  |  |  |  |
| 3 | Authorized-driver approval documented |  |  |  |  |
| 4 | Driver safety training/acknowledgment on file |  |  |  |  |
| 5 | Medical certification on file (if required for the vehicle type) |  |  |  |  |
| 6 | Vehicle assignment and insurance documented |  |  |  |  |
| 7 | Periodic MVR re-check scheduled |  |  |  |  |
...
<sub>Template ID: `driver-qualification-file-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
