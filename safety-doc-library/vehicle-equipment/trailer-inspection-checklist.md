...
|---|---|:--:|:--:|:--:|---|
| 1 | Coupler/hitch secure; safety chains crossed and attached |  |  |  |  |
| 2 | Breakaway cable/brakes functional |  |  |  |  |
| 3 | Tires (including spare) and wheels in good condition |  |  |  |  |
| 4 | Lights and signals working |  |  |  |  |
| 5 | Load secured and within rating; weight distributed |  |  |  |  |
| 6 | Ramps/gates latched |  |  |  |  |
| 7 | Registration/plate valid |  |  |  |  |
...
<sub>Template ID: `trailer-inspection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
