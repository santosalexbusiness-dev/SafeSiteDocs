...
|---|---|:--:|:--:|:--:|---|
| 1 | Fluids checked; no significant leaks |  |  |  |  |
| 2 | Tires/tracks/undercarriage in good condition |  |  |  |  |
| 3 | Lights, horn, and backup alarm work |  |  |  |  |
| 4 | Steering, brakes, and controls function |  |  |  |  |
| 5 | ROPS and seatbelt present and intact |  |  |  |  |
| 6 | Hydraulics, hoses, and attachments secure |  |  |  |  |
| 7 | Fire extinguisher present; cab clean and visibility clear |  |  |  |  |
...
<sub>Template ID: `heavy-equipment-inspection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
