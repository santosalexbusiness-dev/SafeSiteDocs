...
## Template Body
[ Printable tag — fill in, attach, and remove the equipment from service. ]
...
<sub>Template ID: `defective-equipment-tag` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
