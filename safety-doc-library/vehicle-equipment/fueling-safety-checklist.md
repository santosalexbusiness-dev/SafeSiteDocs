...
|---|---|:--:|:--:|:--:|---|
| 1 | Engine off and cool before fueling |  |  |  |  |
| 2 | No smoking or open flames in the fueling area |  |  |  |  |
| 3 | Approved containers used; nozzle/container bonded where required |  |  |  |  |
| 4 | Fuel away from ignition sources and storm drains |  |  |  |  |
| 5 | Spills avoided; spill kit available |  |  |  |  |
| 6 | Area ventilated (no fueling in enclosed spaces) |  |  |  |  |
| 7 | Containers capped and stored properly after fueling |  |  |  |  |
...
<sub>Template ID: `fueling-safety-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
