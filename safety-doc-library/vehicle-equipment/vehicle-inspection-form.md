...
## Template Body
Pre-trip vehicle inspection. Report defects before driving.
...
<sub>Template ID: `vehicle-inspection-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
