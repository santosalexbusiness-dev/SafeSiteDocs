...
## Template Body
For employees who voluntarily use a respirator (e.g., a filtering facepiece/dust mask) where one isn't required.
...
<sub>Template ID: `voluntary-respirator-use-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
