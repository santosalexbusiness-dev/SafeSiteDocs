...
## Template Body
Document respirator selection based on the hazard assessment.
...
<sub>Template ID: `respirator-selection-worksheet` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
