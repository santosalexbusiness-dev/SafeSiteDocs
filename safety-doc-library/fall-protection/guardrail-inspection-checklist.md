...
|---|---|:--:|:--:|:--:|---|
| 1 | Top rail at correct height and present along the exposure |  |  |  |  |
| 2 | Mid rail (or equivalent) present |  |  |  |  |
| 3 | Toeboard present where falling-object risk exists |  |  |  |  |
| 4 | Posts secure and spaced properly |  |  |  |  |
| 5 | System can withstand required force (no flex/looseness) |  |  |  |  |
| 6 | Openings/gaps protected (gates, chains) |  |  |  |  |
| 7 | No damaged or missing components |  |  |  |  |
...
<sub>Template ID: `guardrail-inspection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
