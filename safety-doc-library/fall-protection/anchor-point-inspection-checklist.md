...
|---|---|:--:|:--:|:--:|---|
| 1 | Anchor rated for the required load (or designed by qualified person) |  |  |  |  |
| 2 | Anchor located to limit fall distance and swing falls |  |  |  |  |
| 3 | Anchor and connecting hardware in good condition |  |  |  |  |
| 4 | Compatible connectors used (no roll-out risk) |  |  |  |  |
| 5 | Anchor above the work where feasible |  |  |  |  |
| 6 | Temporary anchors installed per manufacturer instructions |  |  |  |  |
| 7 | Structure supporting anchor is sound |  |  |  |  |
...
<sub>Template ID: `anchor-point-inspection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
