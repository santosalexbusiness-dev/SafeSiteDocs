...
|---|---|:--:|:--:|:--:|---|
| 1 | Warning line set back the required distance from the edge |  |  |  |  |
| 2 | Line flagged and visible; correct height |  |  |  |  |
| 3 | Stanchions stable and able to resist tipping |  |  |  |  |
| 4 | Access path/controlled zone defined |  |  |  |  |
| 5 | Workers between the line and edge use additional protection as required |  |  |  |  |
| 6 | Safety monitor assigned if used |  |  |  |  |
| 7 | System appropriate for the roof slope and task |  |  |  |  |
...
<sub>Template ID: `warning-line-system-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
