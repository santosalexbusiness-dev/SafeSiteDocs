...
|---|---|:--:|:--:|:--:|---|
| 1 | Webbing/cable — no cuts, frays, kinks, or corrosion |  |  |  |  |
| 2 | Stitching — intact |  |  |  |  |
| 3 | Shock-absorbing pack — not deployed/torn |  |  |  |  |
| 4 | SRL — extends and retracts smoothly; locks when pulled sharply |  |  |  |  |
| 5 | Snap hooks/carabiners — self-close and self-lock |  |  |  |  |
| 6 | Labels — legible; within service life |  |  |  |  |
...
<sub>Template ID: `lanyard-inspection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
