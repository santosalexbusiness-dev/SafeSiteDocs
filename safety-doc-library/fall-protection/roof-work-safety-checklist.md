...
|---|---|:--:|:--:|:--:|---|
| 1 | Roof access is safe (secured ladder / stair) |  |  |  |  |
| 2 | Edge protection in place (guardrails or PFAS) |  |  |  |  |
| 3 | Holes and skylights covered or guarded |  |  |  |  |
| 4 | Anchor points rated and positioned correctly |  |  |  |  |
| 5 | Weather and heat conditions assessed |  |  |  |  |
| 6 | Falling-object protection for people below |  |  |  |  |
| 7 | Rescue plan established before work |  |  |  |  |
...
<sub>Template ID: `roof-work-safety-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
