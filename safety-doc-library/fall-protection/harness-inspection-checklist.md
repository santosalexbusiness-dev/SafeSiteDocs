...
|---|---|:--:|:--:|:--:|---|
| 1 | Webbing — no cuts, frays, burns, or chemical/UV damage |  |  |  |  |
| 2 | Stitching — intact, no pulled or broken threads |  |  |  |  |
| 3 | D-rings — no cracks, sharp edges, distortion, or corrosion |  |  |  |  |
| 4 | Buckles — operate properly, no damage |  |  |  |  |
| 5 | Grommets/keepers — intact |  |  |  |  |
| 6 | Labels — present, legible, within service life |  |  |  |  |
| 7 | Overall — no signs of impact loading |  |  |  |  |
...
<sub>Template ID: `harness-inspection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
