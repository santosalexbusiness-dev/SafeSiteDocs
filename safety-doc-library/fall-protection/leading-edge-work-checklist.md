...
|---|---|:--:|:--:|:--:|---|
| 1 | Leading-edge hazard identified and communicated |  |  |  |  |
| 2 | Fall protection selected for leading-edge work (PFAS with appropriate SRL/anchors) |  |  |  |  |
| 3 | Anchors positioned to limit fall distance and swing |  |  |  |  |
| 4 | Warning line / controlled access used only where permitted |  |  |  |  |
| 5 | Workers trained for leading-edge tasks |  |  |  |  |
| 6 | Rescue plan in place |  |  |  |  |
| 7 | Materials and tools secured from falling |  |  |  |  |
...
<sub>Template ID: `leading-edge-work-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
