...
## Plan
**Fall Protection Plan for [COMPANY NAME] — [PROJECT/SITE].** Customize for the actual site and tasks.
...
<sub>Template ID: `fall-protection-plan-template` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
