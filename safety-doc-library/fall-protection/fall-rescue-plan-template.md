...
## Plan
**Prompt rescue must be planned before work at height begins.** A worker suspended in a harness can be harmed quickly.
...
<sub>Template ID: `fall-rescue-plan-template` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
