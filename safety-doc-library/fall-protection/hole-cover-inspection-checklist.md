# Hole Cover Inspection Checklist
...
|---|---|:--:|:--:|:--:|---|
| 1 | All floor/roof holes and openings are covered or guarded |  |  |  |  |
| 2 | Covers capable of supporting the expected load |  |  |  |  |
| 3 | Covers secured against displacement |  |  |  |  |
| 4 | Covers marked 'HOLE' or 'COVER' (or equivalent) |  |  |  |  |
| 5 | No covers removed and left open/unattended |  |  |  |  |
| 6 | Skylights protected (cover, screen, or guardrail) |  |  |  |  |
| 7 | Damaged covers replaced |  |  |  |  |
...
<sub>Template ID: `hole-cover-inspection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
