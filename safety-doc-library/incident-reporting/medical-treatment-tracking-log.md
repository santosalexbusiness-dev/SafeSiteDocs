...
## Log
Track medical treatment and follow-up for work-related injuries (keep confidential).
...
<sub>Template ID: `medical-treatment-tracking-log` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
