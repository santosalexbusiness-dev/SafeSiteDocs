...
## Template Body
Find the underlying causes, not just the immediate one. Use "5 Whys" or a similar method.
...
<sub>Template ID: `root-cause-analysis-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
