...
## Template Body
For the supervisor to review an incident report and initiate follow-up.
...
<sub>Template ID: `supervisor-incident-review-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
