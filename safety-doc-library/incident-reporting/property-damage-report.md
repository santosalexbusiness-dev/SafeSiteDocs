...
## Template Body
Document damage to property or equipment (no injury, or in addition to an injury report).
...
<sub>Template ID: `property-damage-report` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
