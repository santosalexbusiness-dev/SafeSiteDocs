...
## Template Body
Summarize incident activity each month to spot trends.
...
<sub>Template ID: `monthly-incident-summary` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
