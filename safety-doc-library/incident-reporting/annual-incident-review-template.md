...
## Template Body
Review the year's incident data and set direction for next year.
...
<sub>Template ID: `annual-incident-review-template` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
