...
## Log
Log photos taken during an incident investigation or inspection.
...
<sub>Template ID: `photo-evidence-log` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
