...
## Template Body
Document a vehicle incident. Ensure everyone is safe and call 911 if needed.
...
<sub>Template ID: `vehicle-incident-report` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
