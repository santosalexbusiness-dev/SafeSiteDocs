...
## Template Body
Document a work-related injury or illness (also see the company Incident Report Form). Get medical care first.
...
<sub>Template ID: `injury-report-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
