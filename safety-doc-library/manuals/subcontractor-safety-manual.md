...
## Template Body
**Written safety program for [COMPANY NAME] — Subcontractors.** Replace placeholders, delete sections that don't apply, add anything specific to your operations, and have leadership review and approve before use.
