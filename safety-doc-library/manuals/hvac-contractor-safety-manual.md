...
## Template Body
**Written safety program for [COMPANY NAME] — HVAC Contractors.** Replace the bracketed fields, delete sections that don't apply, add anything specific to your operations, and have leadership review and approve before use.
...
### 4. Key Programs & Safe Work Practices
**Primary hazards for hvac contractors:**
- Electrical shock and arc flash
- Falls from ladders, roofs, and attic access
- Refrigerant handling and asphyxiation in confined areas
- Brazing/soldering (hot work) and burns
- Lifting heavy units; cuts from sheet metal

**Programs that apply (customize and attach):**
- Electrical Safety / LOTO
- Fall Protection & Ladder Safety
- Hazard Communication (refrigerants/chemicals)
- Hot Work
- Respiratory & Confined Space awareness

**Core safe work practices:**
- De-energize and lock out before servicing electrical components
- Handle refrigerants per the SDS and ensure ventilation
- Use a hot work permit and fire watch for brazing
- Set ladders safely for roof and attic access
- Team-lift or use equipment for heavy units
...
<sub>Template ID: `hvac-contractor-safety-manual` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
