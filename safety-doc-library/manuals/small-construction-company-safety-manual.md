# Small Construction Company Safety Manual
...
## Template Body
**Written safety program for [COMPANY NAME] — Small Construction Companies.** Replace the bracketed fields, delete sections that don't apply, add anything specific to your operations, and have leadership review and approve before use.
...
- Keep the program practical and right-sized for your crew
- Do daily pre-task planning before each task
- Inspect tools, ladders, and equipment before use
- Use the right PPE for the task
- Report and fix hazards quickly
...
<sub>Template ID: `small-construction-company-safety-manual` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
