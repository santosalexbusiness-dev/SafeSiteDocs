...
## Template Body
**Written safety program for [COMPANY NAME] — Landscaping.** Replace the bracketed fields, delete sections that don't apply, add anything specific to your operations, and have leadership review and approve before use.
...
### 4. Key Programs & Safe Work Practices
**Primary hazards for landscaping:**
- Heat illness from outdoor work
- Mower, trimmer, and blower hazards (thrown objects, blade contact)
- Pesticide and chemical exposure
- Vehicle, trailer, and equipment hazards
- Insect/animal exposure and manual handling strains

**Programs that apply (customize and attach):**
- Heat Illness Prevention
- Hazard Communication (chemicals/pesticides)
- PPE
- Vehicle & Equipment Safety
- Manual Material Handling

**Core safe work practices:**
- Follow the water/rest/shade plan and acclimatize new workers
- Clear debris and bystanders before operating equipment
- Use chemical PPE and follow label/SDS for pesticides
- Inspect trailers, secure loads, and use spotters
- Use eye, face, and hearing protection with equipment
...
<sub>Template ID: `landscaping-safety-manual` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
