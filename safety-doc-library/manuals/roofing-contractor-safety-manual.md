...
## Template Body
**Written safety program for [COMPANY NAME] — Roofing Contractors.** Replace the bracketed fields, delete sections that don't apply, add anything specific to your operations, and have leadership review and approve before use.
...
### 4. Key Programs & Safe Work Practices
**Primary hazards for roofing contractors:**
- Falls from edges, through holes/skylights, and off ladders
- Heat illness on hot roofs
- Hot work from torch-down and kettles
- Material handling and falling objects
- Slips on sloped/wet surfaces
...
- Use guardrails or personal fall arrest with rated anchors
- Cover and protect holes and skylights
- Maintain a fire watch for torch and kettle work
- Apply the water/rest/shade plan in heat
- Control falling material and protect people below
...
<sub>Template ID: `roofing-contractor-safety-manual` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
