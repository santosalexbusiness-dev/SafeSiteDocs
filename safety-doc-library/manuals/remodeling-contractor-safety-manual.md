# Remodeling Contractor Safety Manual
...
| Recommended Industry | Remodeling |
...
### 4. Key Programs & Safe Work Practices
**Primary hazards for remodeling contractors:**
- Silica dust from cutting concrete/masonry/tile
- Lead and asbestos in older homes
- Falls from ladders and scaffolds
- Power tool injuries and dust
- Electrical hazards in existing structures

**Programs that apply (customize and attach):**
- Silica exposure control
- Asbestos & Lead Awareness
- Ladder & Scaffold Safety
- PPE & Respiratory awareness
- Electrical Safety

**Core safe work practices:**
- Use water or vacuum dust controls when cutting masonry/tile
- Stop and assess suspect asbestos/lead materials before disturbing
- Verify circuits are de-energized before opening walls
- Inspect and use tools with guards in place
- Contain dust and protect occupants in occupied spaces
...
<sub>Template ID: `remodeling-contractor-safety-manual` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
