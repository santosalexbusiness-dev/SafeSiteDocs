...
## Template Body
**Written safety program for [COMPANY NAME] — General Contractors.** Replace the bracketed fields, delete sections that don't apply, add anything specific to your operations, and have leadership review and approve before use.
...
### 4. Key Programs & Safe Work Practices
**Primary hazards for general contractors:**
- Falls from heights
- Struck-by (vehicles, equipment, falling objects)
- Caught-in/between (trenches, equipment)
- Electrocution (power lines, temporary power)
- Managing multiple subcontractors and trades
...
- Run a site orientation for every worker and subcontractor
- Hold pre-construction and daily pre-task safety meetings
- Prequalify subcontractors and define safety responsibilities in writing
- Control public exposure with barricades and signage
- Maintain housekeeping and protect openings and edges
...
<sub>Template ID: `general-contractor-safety-manual` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
