...
## Template Body
Identify what training each role or employee needs based on their tasks and hazards.
...
<sub>Template ID: `training-needs-assessment-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
