...
## Log
Record each training an employee completes. Keep with the employee's file.
...
<sub>Template ID: `employee-training-log` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
