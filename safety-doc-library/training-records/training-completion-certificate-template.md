...
## Template Body
[ Printable certificate — customize with your logo and details. ]
...
<sub>Template ID: `training-completion-certificate-template` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
