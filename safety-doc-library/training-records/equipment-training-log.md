...
## Log
Document training and authorization to operate specific equipment.
...
<sub>Template ID: `equipment-training-log` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
