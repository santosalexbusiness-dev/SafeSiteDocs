...
## Template Body
Use to designate a qualified person — someone who, by training, knowledge, and experience, can perform or supervise the specified work safely.
...
<sub>Template ID: `qualified-person-designation-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
