...
## Template Body
Use to designate a competent person — someone who can identify existing and predictable hazards and has authority to take prompt corrective action.
...
<sub>Template ID: `competent-person-designation-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
