...
## Template Body
Plan safety training across the year. Assign topics to months and track completion.
...
<sub>Template ID: `annual-training-calendar` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
