...
## Template Body
Document a coaching or corrective conversation about safety (supportive, not necessarily disciplinary).
...
<sub>Template ID: `employee-coaching-record` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
