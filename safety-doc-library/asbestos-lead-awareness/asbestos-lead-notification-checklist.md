# Asbestos/Lead Notification Checklist
...
|---|---|:--:|:--:|:--:|---|
| 1 | Building age and survey status checked |  |  |  |  |
| 2 | Client/owner asked about known asbestos/lead |  |  |  |  |
| 3 | Prior survey obtained and reviewed (if available) |  |  |  |  |
| 4 | Suspect materials identified and marked |  |  |  |  |
| 5 | Qualified professional engaged for assessment where needed |  |  |  |  |
| 6 | Any required notifications identified (confirm with a qualified firm/authority) |  |  |  |  |
| 7 | Workers informed; do-not-disturb areas communicated |  |  |  |  |
...
<sub>Template ID: `asbestos-lead-notification-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
