...
|---|---|:--:|:--:|:--:|---|
| 1 | Pre-renovation hazard questionnaire completed |  |  |  |  |
| 2 | Asbestos/lead suspect materials assessed (or avoided) |  |  |  |  |
| 3 | Utilities located and de-energized/isolated as needed |  |  |  |  |
| 4 | Dust controls planned (silica, lead, general) |  |  |  |  |
| 5 | Occupant/public protection and containment in place |  |  |  |  |
| 6 | PPE and respiratory protection appropriate to the work |  |  |  |  |
| 7 | Waste handling and cleanup planned |  |  |  |  |
...
<sub>Template ID: `renovation-safety-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
