...
## Template Body
Use the moment a worker encounters or suspects a regulated material (asbestos/lead/other).
...
<sub>Template ID: `suspect-material-stop-work-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
