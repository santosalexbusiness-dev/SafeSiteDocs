...
|---|---|:--:|:--:|:--:|---|
| 1 | Source controls selected (water/wet methods or tool-mounted HEPA vacuum) |  |  |  |  |
| 2 | Containment/enclosure where needed to limit spread |  |  |  |  |
| 3 | Negative pressure/HEPA filtration if required by the task |  |  |  |  |
| 4 | Bystanders and occupants kept clear of the dust zone |  |  |  |  |
| 5 | No dry sweeping of hazardous dust (use water or HEPA vacuum) |  |  |  |  |
| 6 | Respiratory protection per the relevant program |  |  |  |  |
| 7 | Cleanup and waste handling planned (HEPA/wet methods) |  |  |  |  |
...
<sub>Template ID: `dust-control-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
