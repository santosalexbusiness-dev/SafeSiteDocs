# PPE Checklist for Dust-Generating Work
...
|---|---|:--:|:--:|:--:|---|
| 1 | Respiratory protection appropriate to the dust (per program) |  |  |  |  |
| 2 | Eye protection (goggles) for fine dust |  |  |  |  |
| 3 | Coveralls/protective clothing where needed (esp. lead) |  |  |  |  |
| 4 | Gloves appropriate to the task |  |  |  |  |
| 5 | Head and foot protection as required |  |  |  |  |
| 6 | Hygiene plan: wash facilities; no eat/drink/smoke in the area |  |  |  |  |
| 7 | Clothing change-out to prevent take-home contamination |  |  |  |  |
...
<sub>Template ID: `ppe-checklist-for-dust-generating-work` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
