...
## Acknowledgment
I acknowledge that I have received asbestos and lead **awareness** training/information from [COMPANY NAME] and that I understand:
...
<sub>Template ID: `contractor-awareness-acknowledgment` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
