...
## Template Body
Refer suspect regulated materials to a qualified/licensed professional for assessment or abatement.
...
<sub>Template ID: `regulated-material-referral-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
