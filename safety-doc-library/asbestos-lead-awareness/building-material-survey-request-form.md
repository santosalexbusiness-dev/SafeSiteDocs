...
## Template Body
Request a hazardous-materials survey (asbestos/lead) from a qualified firm before disturbing suspect materials.
...
<sub>Template ID: `building-material-survey-request-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
