...
## Template Body
[ Printable sign — fill in, print, and post at the suspect material/area. ]
...
<sub>Template ID: `do-not-disturb-material-sign-template` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
