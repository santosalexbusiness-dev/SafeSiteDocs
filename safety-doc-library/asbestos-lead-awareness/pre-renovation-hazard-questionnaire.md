...
## Template Body
Complete **before** starting renovation/demo to flag regulated materials (asbestos, lead, mold, etc.).
...
<sub>Template ID: `pre-renovation-hazard-questionnaire` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
