...
**Attendance / Sign-In** — Date: [DATE]   Supervisor: [NAME]   Location: [JOBSITE]
...
<sub>Template ID: `lead-awareness-toolbox-talk` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
