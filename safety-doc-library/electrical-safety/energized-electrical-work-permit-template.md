...
## Permit
Required when energized work is justified. Authorize before work; qualified persons only.
...
<sub>Template ID: `energized-electrical-work-permit-template` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
