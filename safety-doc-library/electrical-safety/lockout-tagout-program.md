...
## Program
**Lockout/Tagout (Energy Control) Program for [COMPANY NAME].** Pair with equipment-specific procedures.
...
<sub>Template ID: `lockout-tagout-program` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
