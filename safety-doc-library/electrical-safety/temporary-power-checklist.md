...
|---|---|:--:|:--:|:--:|---|
| 1 | GFCI protection on receptacle circuits (or assured grounding program) |  |  |  |  |
| 2 | Panels and spider boxes labeled and covered |  |  |  |  |
| 3 | Circuits not overloaded |  |  |  |  |
| 4 | Wiring protected from damage; elevated out of walkways/water |  |  |  |  |
| 5 | Weatherproof connections |  |  |  |  |
| 6 | Grounding intact |  |  |  |  |
| 7 | No tampering or missing covers |  |  |  |  |
...
<sub>Template ID: `temporary-power-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
