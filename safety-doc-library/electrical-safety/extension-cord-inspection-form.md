...
## Template Body
Inspect cords before use; remove damaged cords from service.
...
<sub>Template ID: `extension-cord-inspection-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
