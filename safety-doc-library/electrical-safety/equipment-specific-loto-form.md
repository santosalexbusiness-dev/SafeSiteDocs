...
## Template Body
Create one procedure per machine/equipment. Verify with a qualified person.
...
<sub>Template ID: `equipment-specific-loto-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
