...
|---|---|:--:|:--:|:--:|---|
| 1 | Housing not cracked; no exposed wiring |  |  |  |  |
| 2 | Cord and plug intact; ground pin present (if applicable) |  |  |  |  |
| 3 | Switch operates and stays off when released |  |  |  |  |
| 4 | Guards in place and functional |  |  |  |  |
| 5 | Battery/charger (cordless) in good condition |  |  |  |  |
| 6 | Double-insulated or properly grounded |  |  |  |  |
| 7 | Used with GFCI protection on temporary power |  |  |  |  |
...
<sub>Template ID: `electrical-tool-inspection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
