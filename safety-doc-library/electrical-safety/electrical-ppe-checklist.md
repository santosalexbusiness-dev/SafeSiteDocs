...
|---|---|:--:|:--:|:--:|---|
| 1 | Insulating (rubber) gloves rated for voltage; inspected/air-tested; within test date |  |  |  |  |
| 2 | Leather protectors over rubber gloves |  |  |  |  |
| 3 | Arc-rated clothing/face protection per the arc-flash analysis |  |  |  |  |
| 4 | Electrical-class hard hat |  |  |  |  |
| 5 | Insulated tools rated for the voltage |  |  |  |  |
| 6 | Safety glasses/face shield |  |  |  |  |
| 7 | Rubber insulating mats/blankets where applicable |  |  |  |  |
...
<sub>Template ID: `electrical-ppe-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
