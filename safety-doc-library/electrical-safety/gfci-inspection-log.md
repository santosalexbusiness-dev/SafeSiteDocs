...
## Log
Test GFCIs and log results (use the test button or a tester).
...
<sub>Template ID: `gfci-inspection-log` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
