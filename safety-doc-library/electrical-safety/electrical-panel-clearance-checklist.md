...
|---|---|:--:|:--:|:--:|---|
| 1 | Required clear working space in front of the panel maintained |  |  |  |  |
| 2 | No storage of materials in front of/around panels |  |  |  |  |
| 3 | Panel cover/door closes and latches |  |  |  |  |
| 4 | Circuits labeled/identified |  |  |  |  |
| 5 | No exposed energized parts |  |  |  |  |
| 6 | Access path to the panel is clear |  |  |  |  |
| 7 | Adequate lighting at the panel |  |  |  |  |
...
<sub>Template ID: `electrical-panel-clearance-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
