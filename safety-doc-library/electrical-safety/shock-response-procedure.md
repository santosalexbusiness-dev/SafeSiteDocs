...
## Procedure
Post where electrical work occurs. Customize contacts.
...
<sub>Template ID: `shock-response-procedure` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
