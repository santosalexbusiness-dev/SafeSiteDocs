...
## Program
**Electrical Safety Program for [COMPANY NAME].** Customize to your scopes and voltages.
...
<sub>Template ID: `electrical-safety-program` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
