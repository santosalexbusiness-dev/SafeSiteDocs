...
## Template Body
Define how long safety records are kept. **Retention periods vary by record type and jurisdiction — confirm the correct periods for your company.**
...
<sub>Template ID: `safety-records-retention-schedule` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
