...
## Log
Track key safety indicators over time.
...
<sub>Template ID: `safety-kpi-tracker` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
