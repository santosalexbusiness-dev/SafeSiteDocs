...
## Template Body
Summarize safety activity and performance each month.
...
<sub>Template ID: `monthly-safety-report-template` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
