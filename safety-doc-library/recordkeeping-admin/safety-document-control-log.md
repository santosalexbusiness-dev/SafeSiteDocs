...
## Log
Track versions of your safety documents so everyone uses the current one.
...
<sub>Template ID: `safety-document-control-log` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
