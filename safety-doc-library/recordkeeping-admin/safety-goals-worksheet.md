...
## Template Body
Set measurable safety goals and track them.
...
<sub>Template ID: `safety-goals-worksheet` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
