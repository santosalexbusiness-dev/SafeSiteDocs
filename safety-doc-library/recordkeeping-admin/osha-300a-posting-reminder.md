...
## Template Body
Reminder to post the annual summary of work-related injuries and illnesses (OSHA 300A) if your company is required to keep these records.
...
<sub>Template ID: `osha-300a-posting-reminder` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
