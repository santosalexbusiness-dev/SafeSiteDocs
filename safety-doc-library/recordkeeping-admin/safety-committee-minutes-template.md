...
## Template Body
Record decisions and actions from the safety committee meeting.
...
<sub>Template ID: `safety-committee-minutes-template` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
