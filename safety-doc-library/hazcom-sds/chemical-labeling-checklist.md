...
| Field | Value |
|---|---|
| Category | Hazard Communication / SDS |
...
|---|---|:--:|:--:|:--:|---|
| 1 | Shipped containers retain the manufacturer label |  |  |  |  |
| 2 | Labels include product identifier, signal word, pictograms, hazard/precautionary statements |  |  |  |  |
| 3 | Secondary/working containers are labeled with product and hazards |  |  |  |  |
| 4 | Labels are legible and not damaged/faded |  |  |  |  |
| 5 | No unlabeled containers in use or storage |  |  |  |  |
| 6 | Portable container exemption only when used by the same employee in one shift |  |  |  |  |
| 7 | Damaged labels replaced |  |  |  |  |
...
<sub>Template ID: `chemical-labeling-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
