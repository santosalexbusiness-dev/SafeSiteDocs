...
## Template Body
Document a suspected or actual chemical exposure (also complete the company Incident Report Form).
...
<sub>Template ID: `employee-chemical-exposure-report` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
