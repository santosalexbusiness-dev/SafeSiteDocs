...
|---|---|:--:|:--:|:--:|---|
| 1 | Chemicals stored per SDS (temperature, ventilation, compatibility) |  |  |  |  |
| 2 | Incompatible chemicals separated (e.g., oxidizers from flammables) |  |  |  |  |
| 3 | Flammables in approved containers/cabinets, away from ignition |  |  |  |  |
| 4 | Containers closed, labeled, and not damaged/leaking |  |  |  |  |
| 5 | Secondary containment where needed |  |  |  |  |
| 6 | Spill kit available and stocked |  |  |  |  |
| 7 | Storage area clean, ventilated, and access-controlled |  |  |  |  |
...
<sub>Template ID: `chemical-storage-inspection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
