# Annual HazCom Review Checklist
...
|---|---|:--:|:--:|:--:|---|
| 1 | Written program is current and accurate |  |  |  |  |
| 2 | Chemical inventory matches what's actually on site |  |  |  |  |
| 3 | An SDS is on file and accessible for every chemical |  |  |  |  |
| 4 | Containers are properly labeled (primary and secondary) |  |  |  |  |
| 5 | Employees are trained, including on new chemicals/hazards |  |  |  |  |
| 6 | Storage and compatibility are correct |  |  |  |  |
| 7 | Spill response capability and kits are ready |  |  |  |  |
...
<sub>Template ID: `annual-hazcom-review-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
