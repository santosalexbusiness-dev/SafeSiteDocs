...
## Template Body
Use to exchange chemical hazard information with contractors/subcontractors sharing the site.
...
<sub>Template ID: `contractor-chemical-use-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
