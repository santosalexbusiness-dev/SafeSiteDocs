...
## Template Body
[ Printable secondary container label — fill in and affix. ]
...
<sub>Template ID: `secondary-container-label-template` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
