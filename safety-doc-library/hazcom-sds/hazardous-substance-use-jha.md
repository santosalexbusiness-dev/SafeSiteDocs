...
## Job Hazard Analysis
**Task / Job:** Working with a hazardous substance ([PRODUCT])   **Location:** [____]   **Date:** [DATE]
...
<sub>Template ID: `hazardous-substance-use-jha` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
