...
## Template Body
Review new chemicals before bringing them on site.
...
<sub>Template ID: `new-chemical-approval-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
