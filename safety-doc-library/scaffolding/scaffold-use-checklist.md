...
|---|---|:--:|:--:|:--:|---|
| 1 | Current green inspection tag present |  |  |  |  |
| 2 | Fully planked with guardrails and toeboards |  |  |  |  |
| 3 | Safe access in use (no climbing braces) |  |  |  |  |
| 4 | Load within rated capacity; platform clear of excess material |  |  |  |  |
| 5 | Fall protection used where required |  |  |  |  |
| 6 | Falling-object protection for people below |  |  |  |  |
| 7 | No damage, missing components, or alterations |  |  |  |  |
...
<sub>Template ID: `scaffold-use-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
