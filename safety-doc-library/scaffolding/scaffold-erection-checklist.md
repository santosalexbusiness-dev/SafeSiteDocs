...
|---|---|:--:|:--:|:--:|---|
| 1 | Foundation firm and level; base plates and mud sills used |  |  |  |  |
| 2 | Frames/standards plumb and level |  |  |  |  |
| 3 | Bracing installed per the design |  |  |  |  |
| 4 | Planking complete, sound, and secured against movement |  |  |  |  |
| 5 | Guardrails and toeboards installed |  |  |  |  |
| 6 | Ties/anchors installed at required intervals for height |  |  |  |  |
| 7 | Safe access provided; clearance from power lines |  |  |  |  |
...
<sub>Template ID: `scaffold-erection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
