...
## Template Body
A competent person inspects the scaffold before each shift and after changes.
...
<sub>Template ID: `daily-scaffold-inspection-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
