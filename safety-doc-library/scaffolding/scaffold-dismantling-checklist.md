# Scaffold Dismantling Checklist
...
|---|---|:--:|:--:|:--:|---|
| 1 | Dismantling plan/sequence established |  |  |  |  |
| 2 | Area below barricaded; no unauthorized entry |  |  |  |  |
| 3 | Fall protection maintained for workers during dismantling |  |  |  |  |
| 4 | Components lowered, not dropped; falling-object controls |  |  |  |  |
| 5 | Ties removed only in the proper sequence |  |  |  |  |
| 6 | Workers trained for dismantling tasks |  |  |  |  |
| 7 | Components inspected and sorted (damaged removed from service) |  |  |  |  |
...
<sub>Template ID: `scaffold-dismantling-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
