...
## Template Body
Designate a competent person for scaffolding.
...
<sub>Template ID: `scaffold-competent-person-designation` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
