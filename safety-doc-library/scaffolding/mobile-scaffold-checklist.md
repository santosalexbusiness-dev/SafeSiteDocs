...
|---|---|:--:|:--:|:--:|---|
| 1 | Casters lock and are in good condition; locked during use |  |  |  |  |
| 2 | Height-to-base ratio within safe limits (outriggers if required) |  |  |  |  |
| 3 | Fully planked with guardrails |  |  |  |  |
| 4 | No workers or loose materials on the platform while moving |  |  |  |  |
| 5 | Floor is level, firm, and free of holes/obstructions |  |  |  |  |
| 6 | Moved only by pushing at the base, watching for overhead hazards |  |  |  |  |
| 7 | Within rated capacity |  |  |  |  |
...
<sub>Template ID: `mobile-scaffold-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
