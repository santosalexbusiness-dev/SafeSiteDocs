...
## Template Body
Use this short quiz to confirm understanding after orientation. Customize questions and the answer key to your program.
...
<sub>Template ID: `new-hire-quiz-template` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
