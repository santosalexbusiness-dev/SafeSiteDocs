...
## Template Body
**How to report a hazard at [COMPANY NAME]**
...
<sub>Template ID: `hazard-reporting-instructions` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
