...
## Template Body
Complete and keep this confidential form on file. Information is voluntary where noted and used only for emergencies.
...
<sub>Template ID: `employee-emergency-contact-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
