...
| # | Item | ✔ | Initials |
|---|---|:--:|---|
| 1 | Reviewed the company safety program and policies |  |  |
| 2 | Understands how to run pre-task planning and toolbox talks |  |  |
| 3 | Knows how to conduct and document training |  |  |
| 4 | Knows the inspection and corrective-action process |  |  |
| 5 | Knows the incident reporting and investigation process |  |  |
| 6 | Understands enforcement and the disciplinary policy |  |  |
| 7 | Knows emergency procedures and how to account for the crew |  |  |
| 8 | Knows where safety documents, forms, and SDSs are kept |  |  |
| 9 | Understands subcontractor and multi-trade coordination |  |  |
| 10 | Knows their authority to stop unsafe work and support workers who do |  |  |
...
<sub>Template ID: `supervisor-orientation-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
