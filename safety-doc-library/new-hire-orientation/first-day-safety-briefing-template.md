...
## Template Body
Cover these topics with the new employee on day one. Check each and add notes.
...
<sub>Template ID: `first-day-safety-briefing-template` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
