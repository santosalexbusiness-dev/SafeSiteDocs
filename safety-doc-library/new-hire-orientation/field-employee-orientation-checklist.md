# Field Employee Orientation Checklist
...
| # | Item | ✔ | Initials |
|---|---|:--:|---|
| 1 | Site-specific hazards and controls reviewed |  |  |
| 2 | Required PPE for the site issued and worn |  |  |
| 3 | Fall protection, ladder, and scaffold requirements explained |  |  |
| 4 | Electrical and temporary power hazards reviewed |  |  |
| 5 | Housekeeping and material handling expectations covered |  |  |
| 6 | Tool and equipment inspection demonstrated |  |  |
| 7 | Emergency procedures, exits, and muster point reviewed |  |  |
| 8 | Hazard and incident reporting explained |  |  |
| 9 | Stop-work authority explained |  |  |
| 10 | Coordination with other trades and site rules covered |  |  |
...
<sub>Template ID: `field-employee-orientation-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
