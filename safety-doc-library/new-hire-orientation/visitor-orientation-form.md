...
## Template Body
Complete for each visitor before they enter work areas.
...
<sub>Template ID: `visitor-orientation-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
