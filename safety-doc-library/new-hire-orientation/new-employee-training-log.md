...
## Log
Record each training the new employee completes during onboarding.
...
<sub>Template ID: `new-employee-training-log` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
