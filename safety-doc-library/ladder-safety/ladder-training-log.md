...
## Log
Document ladder safety training.
...
<sub>Template ID: `ladder-training-log` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
