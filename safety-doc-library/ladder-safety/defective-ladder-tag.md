...
## Template Body
[ Printable tag — fill in, attach to the ladder, and remove the ladder from service. ]
...
<sub>Template ID: `defective-ladder-tag` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
