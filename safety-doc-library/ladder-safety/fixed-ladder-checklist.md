...
|---|---|:--:|:--:|:--:|---|
| 1 | Rungs and rails secure, not corroded or damaged |  |  |  |  |
| 2 | Anchorage/mounting bolts tight |  |  |  |  |
| 3 | Cage, well, or fall protection present where required |  |  |  |  |
| 4 | Clearances around the ladder maintained |  |  |  |  |
| 5 | No obstructions on the climbing path |  |  |  |  |
| 6 | Landing/grab points secure |  |  |  |  |
...
<sub>Template ID: `fixed-ladder-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
