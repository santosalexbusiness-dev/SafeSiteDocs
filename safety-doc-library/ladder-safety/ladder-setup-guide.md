...
## Template Body
Quick reference for safe ladder setup. Post or share with crews.
...
<sub>Template ID: `ladder-setup-guide` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
