...
| 2 | Steps tight, not bent or slippery |  |  |  |  |
| 3 | Spreader bars present and lock fully open |  |  |  |  |
| 4 | Feet/pads present and not worn |  |  |  |  |
| 5 | Hinges and hardware tight, no missing rivets |  |  |  |  |
| 6 | Duty rating label legible and correct for the load |  |  |  |  |
| 7 | No makeshift repairs; structurally sound |  |  |  |  |
...
<sub>Template ID: `step-ladder-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
