...
## Template Body
Use to document a ladder-related incident or near miss (also complete the company Incident Report Form).
...
<sub>Template ID: `ladder-incident-report-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
