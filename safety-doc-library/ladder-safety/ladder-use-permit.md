...
## Permit
Optional permit for higher-risk ladder use. Complete before work.
...
<sub>Template ID: `ladder-use-permit` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
