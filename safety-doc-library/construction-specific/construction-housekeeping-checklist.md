# Construction Housekeeping Checklist
...
|---|---|:--:|:--:|:--:|---|
| 1 | Walkways, stairs, ramps, and exits clear |  |  |  |  |
| 2 | Material stored/stacked safely, not blocking access |  |  |  |  |
| 3 | Debris and scrap removed to proper containers |  |  |  |  |
| 4 | Protruding nails bent/removed; sharp debris controlled |  |  |  |  |
| 5 | Cords and hoses managed to prevent trips |  |  |  |  |
| 6 | Spills cleaned up; flammable waste controlled |  |  |  |  |
| 7 | Openings/holes covered and marked |  |  |  |  |
...
<sub>Template ID: `construction-housekeeping-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
