# Jobsite Closeout Safety Checklist
...
|---|---|:--:|:--:|:--:|---|
| 1 | Temporary protections removed safely (after no longer needed) |  |  |  |  |
| 2 | Openings/penetrations permanently protected/closed |  |  |  |  |
| 3 | Tools, equipment, and materials removed/secured |  |  |  |  |
| 4 | Hazardous materials/waste removed and disposed properly |  |  |  |  |
| 5 | Temporary power and utilities safely disconnected |  |  |  |  |
| 6 | Site cleaned; debris removed |  |  |  |  |
| 7 | Records (inspections, training, incidents) filed |  |  |  |  |
...
<sub>Template ID: `jobsite-closeout-safety-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
