...
## Plan
**Construction Site Safety Plan for [PROJECT].** Complete before mobilizing; review with all on site.
...
<sub>Template ID: `construction-site-safety-plan` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
