...
## Template Body
Document site safety orientation for each worker entering the site.
...
<sub>Template ID: `site-safety-orientation-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
