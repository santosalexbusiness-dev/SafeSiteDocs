...
|---|---|:--:|:--:|:--:|---|
| 1 | Materials stacked stable, bound/blocked to prevent sliding |  |  |  |  |
| 2 | Stacks not too high; load limits respected (floors/racks) |  |  |  |  |
| 3 | Aisles and access maintained around storage |  |  |  |  |
| 4 | Flammables/chemicals stored per SDS and separated |  |  |  |  |
| 5 | Heavy items stored low; mechanical aids available |  |  |  |  |
| 6 | Storage clear of exits, panels, and fire equipment |  |  |  |  |
| 7 | Wind/weather considered for outdoor storage |  |  |  |  |
...
<sub>Template ID: `material-storage-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
