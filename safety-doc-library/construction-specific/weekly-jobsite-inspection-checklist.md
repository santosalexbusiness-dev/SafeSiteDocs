# Weekly Jobsite Inspection Checklist
...
|---|---|:--:|:--:|:--:|---|
| 1 | All daily-checklist items reviewed and trends noted |  |  |  |  |
| 2 | Fall protection systems and anchors verified |  |  |  |  |
| 3 | Scaffold tags current; ladders in good condition |  |  |  |  |
| 4 | Electrical/temporary power and GFCIs tested |  |  |  |  |
| 5 | Excavation protective systems and access verified |  |  |  |  |
| 6 | Equipment inspections and maintenance up to date |  |  |  |  |
| 7 | HazCom: inventory, labels, SDSs current |  |  |  |  |
| 8 | Emergency equipment inspected (extinguishers, first aid) |  |  |  |  |
| 9 | Subcontractor compliance reviewed |  |  |  |  |
| 10 | Open corrective actions tracked to closure |  |  |  |  |
...
<sub>Template ID: `weekly-jobsite-inspection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
