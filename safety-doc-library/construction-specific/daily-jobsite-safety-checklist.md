...
|---|---|:--:|:--:|:--:|---|
| 1 | Housekeeping: walkways, stairs, exits clear |  |  |  |  |
| 2 | Fall hazards protected (edges, holes, leading edges) |  |  |  |  |
| 3 | Ladders and scaffolds inspected and tagged |  |  |  |  |
| 4 | Electrical: GFCI, cords, panels OK |  |  |  |  |
| 5 | PPE in use for the tasks and area |  |  |  |  |
| 6 | Tools and equipment inspected |  |  |  |  |
| 7 | Excavations/trenches protected and inspected (if any) |  |  |  |  |
| 8 | Chemicals labeled; SDSs available; storage OK |  |  |  |  |
| 9 | Fire extinguishers accessible; combustibles controlled |  |  |  |  |
| 10 | Emergency info posted; first aid available |  |  |  |  |
...
<sub>Template ID: `daily-jobsite-safety-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
