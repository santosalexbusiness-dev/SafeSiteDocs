...
## Template Body
Agreement of safety expectations between [COMPANY NAME] and the subcontractor.
...
<sub>Template ID: `subcontractor-safety-agreement` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
