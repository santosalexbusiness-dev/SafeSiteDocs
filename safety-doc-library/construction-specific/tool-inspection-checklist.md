...
|---|---|:--:|:--:|:--:|---|
| 1 | Power tools: housing, cord, and plug intact; guards in place |  |  |  |  |
| 2 | Switches operate and don't stick on |  |  |  |  |
| 3 | Blades/bits sharp, correct, and secure |  |  |  |  |
| 4 | Hand tools: no cracked handles or mushroomed heads |  |  |  |  |
| 5 | Pneumatic tools: hoses/fittings secure; safety clips |  |  |  |  |
| 6 | Damaged tools tagged and removed from service |  |  |  |  |
| 7 | GFCI protection used for corded tools on temporary power |  |  |  |  |
...
<sub>Template ID: `tool-inspection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
