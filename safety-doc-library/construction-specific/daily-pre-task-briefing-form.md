...
## Template Body
Brief the crew before the task/shift.
...
<sub>Template ID: `daily-pre-task-briefing-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
