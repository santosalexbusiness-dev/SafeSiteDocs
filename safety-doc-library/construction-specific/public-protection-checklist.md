...
|---|---|:--:|:--:|:--:|---|
| 1 | Site perimeter secured (fencing/barriers) |  |  |  |  |
| 2 | Pedestrian routes protected and clearly marked |  |  |  |  |
| 3 | Overhead protection where work is above walkways |  |  |  |  |
| 4 | Falling-object and debris controls in place |  |  |  |  |
| 5 | Signage and barricades for hazards and openings |  |  |  |  |
| 6 | Traffic control plan where work affects roadways |  |  |  |  |
| 7 | Site secured against unauthorized entry after hours |  |  |  |  |
...
<sub>Template ID: `public-protection-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
