...
## Template Body
Use to run a pre-construction (kickoff) safety meeting.
...
<sub>Template ID: `pre-construction-safety-meeting-agenda` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
