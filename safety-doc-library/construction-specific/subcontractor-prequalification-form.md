...
## Template Body
Evaluate a subcontractor's safety before award. Customize to your criteria.
...
<sub>Template ID: `subcontractor-prequalification-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
