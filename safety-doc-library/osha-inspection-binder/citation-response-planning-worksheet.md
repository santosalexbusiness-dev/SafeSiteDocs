...
## Template Body
If a citation is received, use this worksheet to organize your response. **Consult legal counsel before responding to any citation; do not treat this as legal advice.**
...
<sub>Template ID: `citation-response-planning-worksheet` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Custom Binder.</sub>
