...
## Index
Index of training records maintained by [COMPANY NAME].
...
<sub>Template ID: `training-records-index` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
