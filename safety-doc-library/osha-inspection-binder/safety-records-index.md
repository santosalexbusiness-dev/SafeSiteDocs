...
## Index
Index of safety records maintained by [COMPANY NAME]. Use to locate records quickly.
...
<sub>Template ID: `safety-records-index` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
