...
## Template Body
Record the key facts at the opening conference.
...
<sub>Template ID: `inspection-opening-conference-notes-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
