...
## Template Body
A plain-language general summary to help you prepare. **This is educational only, not legal advice — confirm your specific rights and obligations with qualified legal counsel.**
...
<sub>Template ID: `employer-rights-during-inspection-summary` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Custom Binder.</sub>
