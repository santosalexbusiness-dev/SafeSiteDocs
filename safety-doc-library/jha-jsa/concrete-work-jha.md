...
## Job Hazard Analysis
**Task / Job:** Concrete forming, placing, and finishing   **Location:** [LOCATION]   **Date:** [DATE]   **Competent Person:** [NAME]
...
|---|---|---|---|
| Formwork and rebar | Impalement; struck-by; strains | Rebar impalement caps; brace/secure forms; team lifts | [Name] |
| Mix and place | Skin burns from wet concrete; silica dust | Skin protection and eyewash; dust controls when cutting/grinding | [Name] |
| Pumping / equipment | Hose whip; struck-by; pinch points | Secure lines; use spotters; keep clear of moving parts | [Name] |
| Finishing | Strains; kneeling injuries; slips | Knee pads; good posture; housekeeping and footing | [Name] |

**Required PPE:** Waterproof gloves and boots, eye protection, knee pads; respirator for cutting/grinding
**Permits / programs that may apply:** Silica exposure control plan for cutting/grinding; HazCom for admixtures
...
<sub>Template ID: `concrete-work-jha` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
