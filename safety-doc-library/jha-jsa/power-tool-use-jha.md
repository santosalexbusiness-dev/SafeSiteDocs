...
## Job Hazard Analysis
**Task / Job:** Use of portable power tools   **Location:** [LOCATION]   **Date:** [DATE]   **Competent Person:** [NAME]
...
|---|---|---|---|
| Select and inspect tool | Defective tool; missing guard | Use the right tool; inspect cord, blade/bit, and guard; remove damaged tools | [Name] |
| Set up the work | Workpiece movement; line of fire | Secure the workpiece; clear the line of fire; keep bystanders back | [Name] |
| Operate the tool | Cuts/amputation; kickback; flying debris | Keep guards in place; maintain control; eye/face protection | [Name] |
| Change blades / clear jams | Unexpected start-up | Disconnect power before changing blades/bits or clearing jams | [Name] |

**Required PPE:** Eye/face protection, hearing protection, appropriate gloves; dust control as needed
**Permits / programs that may apply:** Manufacturer instructions; silica control plan if cutting masonry/concrete
...
<sub>Template ID: `power-tool-use-jha` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
