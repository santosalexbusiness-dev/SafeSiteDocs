...
## Job Hazard Analysis
**Task / Job:** Operating a company vehicle   **Location:** [LOCATION]   **Date:** [DATE]   **Competent Person:** [NAME]
...
|---|---|---|---|
| Pre-trip inspection | Mechanical failure | Inspect tires, brakes, lights, fluids; report defects before driving | [Name] |
| Load and secure | Shifting or falling loads | Secure and distribute the load; stay within rating | [Name] |
| Drive | Collisions; distraction; fatigue | Seatbelt; no handheld phone; rested; obey traffic laws and speed | [Name] |
| Back and park | Striking pedestrians; rollaway | Walk-around; spotter for blind backing; set brake/chock on grades | [Name] |

**Required PPE:** Seatbelt; high-visibility vest when out of the vehicle
**Permits / programs that may apply:** Valid license; company authorized-driver list
...
<sub>Template ID: `vehicle-operation-jha` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
