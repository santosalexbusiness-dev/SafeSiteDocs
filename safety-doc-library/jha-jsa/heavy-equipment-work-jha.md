...
## Job Hazard Analysis
**Task / Job:** Operating heavy equipment   **Location:** [LOCATION]   **Date:** [DATE]   **Competent Person:** [NAME]
...
|---|---|---|---|
| Pre-use inspection | Mechanical/hydraulic failure | Daily inspection; report defects; verify ROPS and seatbelt | [Name] |
| Set up the work zone | Struck-by; swing radius contact | Barricade swing radius; assign spotters; high-visibility; agreed signals | [Name] |
| Operate | Tip-over; overhead lines; underground utilities | Stable ground; respect capacity; maintain clearance from lines; utilities located | [Name] |
| Ground workers nearby | Workers on foot struck or crushed | Eye contact before approach; keep clear of blind spots and under loads | [Name] |

**Required PPE:** Hard hat, high-visibility clothing, footwear, eye/hearing protection; seatbelt
**Permits / programs that may apply:** Operator training/authorization; spotter plan
...
<sub>Template ID: `heavy-equipment-work-jha` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
