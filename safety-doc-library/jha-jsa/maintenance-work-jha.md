...
## Job Hazard Analysis
**Task / Job:** General maintenance and repair   **Location:** [LOCATION]   **Date:** [DATE]   **Competent Person:** [NAME]
...
|---|---|---|---|
| Plan the task | Unexpected energy; mixed hazards | Identify all energy sources; apply LOTO when servicing equipment | [Name] |
| Access the work area | Falls; ladders; tight spaces | Use appropriate access; apply fall or confined-space controls as needed | [Name] |
| Perform maintenance | Electrical, mechanical, chemical hazards | Correct tools and PPE; verify de-energized; follow procedures | [Name] |
| Return to service | Start-up hazards | Reinstall guards; remove LOTO per procedure; test before normal use | [Name] |

**Required PPE:** Task-dependent: eye protection, gloves, hearing protection, electrical-rated PPE as needed
**Permits / programs that may apply:** LOTO; confined space / hot work programs if applicable
...
<sub>Template ID: `maintenance-work-jha` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
