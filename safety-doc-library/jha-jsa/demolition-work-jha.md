...
## Job Hazard Analysis
**Task / Job:** Demolition   **Location:** [LOCATION]   **Date:** [DATE]   **Competent Person:** [NAME]
...
|---|---|---|---|
| Pre-demolition survey | Hidden asbestos/lead; live utilities | Hazardous-materials survey; locate and disconnect utilities | [Name] |
| Establish controls | Falling debris; structural collapse; dust | Engineering survey for structural work; exclusion zones; dust control | [Name] |
| Demolition activity | Struck-by; falls; silica/lead dust | Plan the sequence; fall protection; respiratory protection; water for dust | [Name] |
| Debris handling | Cuts; strains; chute hazards | Controlled chutes/containers; PPE; ongoing housekeeping | [Name] |

**Required PPE:** Hard hat, eye/face protection, gloves, respiratory protection, high-visibility clothing, footwear
**Permits / programs that may apply:** Asbestos/lead surveys; utility disconnect; engineering survey
...
<sub>Template ID: `demolition-work-jha` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
