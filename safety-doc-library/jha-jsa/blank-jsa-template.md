...
## Job Hazard Analysis
**Task / Job:** [DESCRIBE TASK]   **Location:** [LOCATION]   **Date:** [DATE]   **Supervisor:** [NAME]
...
<sub>Template ID: `blank-jsa-template` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
