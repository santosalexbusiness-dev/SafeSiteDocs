...
| Field | Value |
|---|---|
| Category | Job Hazard Analysis / JHA / JSA |
| Recommended Industry | All |
| Document Type | JHA/JSA |
...
Complete this analysis with the crew before the task. List the task steps, identify the hazards in each step, and document the controls. Review it on site and update it if conditions change.

---

## Job Hazard Analysis
**Task / Job:** Electrical installation / service work   **Location:** [LOCATION]   **Date:** [DATE]   **Competent Person:** [NAME]
...
|---|---|---|---|
| Plan and verify scope | Working on the wrong circuit; arc flash; shock | Confirm scope and circuit; identify qualified persons; review one-line/labels | [Name] |
| Isolate and lock out | Unexpected energization; stored energy | Apply LOTO per equipment procedure; verify zero energy (test before touch) | [Name] |
| Perform de-energized work | Residual shock; dropped tools; cuts | Insulated tools; maintain order; secure tools at height | [Name] |
| Energized work (only if unavoidable) | Arc flash; shock; burns | Energized work permit; qualified persons only; arc-rated PPE; approach boundaries; insulated tools | [Name] |
| Restore and clean up | Re-energization; trip hazards | Reinstall covers/guards; remove locks per procedure; housekeeping | [Name] |

**Required PPE:** Safety glasses, electrical-rated/insulating gloves where required, arc-rated clothing per analysis, hard hat (electrical class), footwear
**Permits / programs that may apply:** LOTO Program, Energized Electrical Work Permit, electrical safe work practices
...
<sub>Template ID: `electrical-work-jha` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
