...
## Job Hazard Analysis
**Task / Job:** Work on a roof or elevated surface   **Location:** [LOCATION]   **Date:** [DATE]   **Competent Person:** [NAME]
...
|---|---|---|---|
| Access the roof | Falls during access; ladder failure | Secured, inspected ladder; maintain access fall protection | [Name] |
| Set up fall protection | Falls from edges, holes, skylights | Guardrails or personal fall arrest with rated anchors; cover/guard holes and skylights | [Name] |
| Perform roof work | Falls; heat; slips; falling tools | Maintain fall protection; manage heat; secure footing; tether/secure tools; control debris | [Name] |
| Move materials on roof | Overloading; falling material | Distribute loads; keep edges clear; falling-object protection for those below | [Name] |
| Rescue readiness | Suspension trauma after a fall | Fall rescue plan established before work begins | [Name] |

**Required PPE:** Full-body harness and connectors (as required), hard hat, eye protection, slip-resistant footwear
**Permits / programs that may apply:** Fall Protection Plan, Fall Rescue Plan, Roof Work Safety Checklist
...
<sub>Template ID: `roof-work-jha` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
