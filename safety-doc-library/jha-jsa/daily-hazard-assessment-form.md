...
## Template Body
Walk the work area at the start of the day and check for hazards. Mark each, note actions, and assign follow-up.
...
<sub>Template ID: `daily-hazard-assessment-form` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
