...
## Job Hazard Analysis
**Task / Job:** Working with chemicals   **Location:** [LOCATION]   **Date:** [DATE]   **Competent Person:** [NAME]
...
|---|---|---|---|
| Review the SDS | Unknown chemical hazards | Read the SDS; identify required PPE, ventilation, and first aid | [Name] |
| Set up | Splash; vapor build-up | Ventilation; secondary containment; eyewash available | [Name] |
| Use the chemical | Skin/eye contact; inhalation | PPE per SDS; correct handling; no eating, drinking, or smoking | [Name] |
| Store and dispose | Reactions; spills | Proper labeled storage; spill kit ready; correct disposal | [Name] |

**Required PPE:** Per SDS: chemical-resistant gloves, eye/face protection, respirator, apron as required
**Permits / programs that may apply:** Hazard Communication program; Spill Response Plan
...
<sub>Template ID: `chemical-use-jha` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
