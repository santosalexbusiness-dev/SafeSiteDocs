...
## Job Hazard Analysis
**Task / Job:** Entry into a confined space   **Location:** [LOCATION]   **Date:** [DATE]   **Competent Person:** [NAME]
...
|---|---|---|---|
| Identify and classify | Unknown or permit-required hazards | Determine if permit-required; follow the confined space program; no entry if untrained | [Name] |
| Test the atmosphere | Oxygen deficiency; toxic/flammable gases | Test before and continuously during entry; ventilate as needed | [Name] |
| Set up entry | Engulfment; entrapment; energy | Isolate energy/material (LOTO); post an attendant; stage retrieval equipment | [Name] |
| Entry and work | Emergencies; failed rescue | Maintain communication; non-entry rescue plan; never perform unplanned rescue | [Name] |

**Required PPE:** Calibrated gas monitor, harness and retrieval line, respiratory protection and PPE per hazard
**Permits / programs that may apply:** Permit-Required Confined Space program; entry permit; LOTO
...
<sub>Template ID: `confined-space-jha` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
