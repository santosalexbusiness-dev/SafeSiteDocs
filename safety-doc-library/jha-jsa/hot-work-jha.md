...
## Job Hazard Analysis
**Task / Job:** Welding, cutting, or grinding (hot work)   **Location:** [LOCATION]   **Date:** [DATE]   **Competent Person:** [NAME]
...
|---|---|---|---|
| Prepare the area | Fire from sparks and slag | Hot work permit; remove or cover combustibles; stage an extinguisher | [Name] |
| Check enclosed items | Explosion of flammable vapors | Test/clean tanks, drums, and pipes before cutting; never assume empty | [Name] |
| Perform hot work | Burns; toxic fumes; arc-eye | Proper PPE; ventilation; welding screens | [Name] |
| Fire watch | Smoldering fire after work ends | Post a fire watch during and for the required time after; final inspection | [Name] |

**Required PPE:** Welding helmet/eye and face protection, flame-resistant clothing, gloves; ventilation/respirator as needed
**Permits / programs that may apply:** Hot Work Permit; Fire Prevention Plan
...
<sub>Template ID: `hot-work-jha` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
