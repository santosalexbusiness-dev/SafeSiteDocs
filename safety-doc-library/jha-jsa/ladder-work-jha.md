...
## Job Hazard Analysis
**Task / Job:** Work performed from portable ladders   **Location:** [LOCATION]   **Date:** [DATE]   **Competent Person:** [NAME]
...
|---|---|---|---|
| Select ladder | Wrong type or duty rating; defects | Choose correct type/rating; inspect before use; remove damaged ladders | [Name] |
| Set up ladder | Slipping out; tipping; power-line contact | Firm level base; correct angle; secure top/bottom; extend above landing; non-conductive near electrical | [Name] |
| Climb and work | Falls; overreaching | Three points of contact; face the ladder; keep belt buckle within rails; no top rungs | [Name] |
| Handle tools/materials | Dropped objects; loss of balance | Use a tool belt/hoist line; keep hands free to climb; warn people below | [Name] |

**Required PPE:** Hard hat, eye protection, footwear; fall protection if required by task/height
**Permits / programs that may apply:** Ladder Safety Program; Ladder Use Permit (if used)
...
<sub>Template ID: `ladder-work-jha` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
