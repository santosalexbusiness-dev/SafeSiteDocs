...
## Plan
Complete this pre-task plan with the crew at the start of the task or shift.
...
<sub>Template ID: `pre-task-plan-template` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
