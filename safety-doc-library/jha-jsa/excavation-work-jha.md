...
## Job Hazard Analysis
**Task / Job:** Excavation and trenching   **Location:** [LOCATION]   **Date:** [DATE]   **Competent Person:** [NAME]
...
|---|---|---|---|
| Locate utilities | Striking gas, electric, or water lines | Call 811 / locate service; hand-dig near marked lines | [Name] |
| Open excavation | Cave-in / collapse | Competent person selects sloping, shoring, or shielding by soil and depth | [Name] |
| Provide access/egress | Trapped without an exit | Ladder or ramp within the required distance of workers | [Name] |
| Work in excavation | Cave-in; bad atmosphere; water; falling loads | Daily and after-change inspection; keep spoil/equipment back from edge; test atmosphere where needed; manage water | [Name] |

**Required PPE:** Hard hat, high-visibility clothing, footwear, eye protection
**Permits / programs that may apply:** Excavation program / competent-person inspection; confined space program if applicable
...
<sub>Template ID: `excavation-work-jha` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
