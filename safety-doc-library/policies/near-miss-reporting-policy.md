...
## Policy
**1. Purpose** — Encourage reporting of close calls to prevent future incidents.

**2. Scope** — All employees of [COMPANY NAME].

**3. Policy Statement** — Near misses are valuable warnings. Reporting them is encouraged and never disciplined.
...
<sub>Template ID: `near-miss-reporting-policy` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
