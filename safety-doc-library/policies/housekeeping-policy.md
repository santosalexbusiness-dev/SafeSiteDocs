...
## Policy
**1. Purpose** — Keep worksites clean and organized to prevent injuries and fires.

**2. Scope** — All employees and worksites of [COMPANY NAME].

**3. Policy Statement** — Good housekeeping is a continuous, everyone's-job standard — not an end-of-day task.
...
<sub>Template ID: `housekeeping-policy` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
