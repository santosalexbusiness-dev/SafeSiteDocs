...
## Policy
**1. Purpose** — Ensure safe operation of company and personal vehicles on company business.

**2. Scope** — All employees who drive on company business for [COMPANY NAME].

**3. Policy Statement** — Drivers operate vehicles safely, legally, and without distraction.
...
<sub>Template ID: `vehicle-safety-policy` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
