...
## Policy
**1. Purpose** — Support injured employees returning to work safely, including modified duty.

**2. Scope** — All employees of [COMPANY NAME] returning from a work-related injury or illness.

**3. Policy Statement** — The company supports a safe and timely return to work, offering transitional or modified duty where appropriate and consistent with medical guidance.
...
<sub>Template ID: `return-to-work-policy` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
