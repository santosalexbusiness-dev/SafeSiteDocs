# Management Safety Responsibilities Policy
...
## Policy
**1. Purpose** — Define management's accountability for safety leadership and resources.

**2. Scope** — All owners, managers, and supervisors at [COMPANY NAME].

**3. Policy Statement** — Management owns the safety program and is accountable for providing a safe workplace and the resources to maintain it.
...
<sub>Template ID: `management-safety-responsibilities-policy` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
