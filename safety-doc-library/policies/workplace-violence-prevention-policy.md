...
## Policy
**1. Purpose** — Prevent and respond to threats, intimidation, and violence at work.

**2. Scope** — All employees, subcontractors, and visitors at [COMPANY NAME].

**3. Policy Statement** — The company has zero tolerance for threats, intimidation, harassment, or acts of violence in the workplace.
...
<sub>Template ID: `workplace-violence-prevention-policy` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
