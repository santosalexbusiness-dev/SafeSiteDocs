...
## Policy
**1. Purpose** — Ensure timely reporting and investigation of incidents.

**2. Scope** — All employees of [COMPANY NAME].

**3. Policy Statement** — All injuries, illnesses, and significant incidents are reported promptly so workers get care and causes get fixed.
...
<sub>Template ID: `incident-reporting-policy` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
