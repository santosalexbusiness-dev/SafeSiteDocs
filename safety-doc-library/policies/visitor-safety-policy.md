...
## Policy
**1. Purpose** — Keep visitors safe and informed on worksites.

**2. Scope** — All visitors to [COMPANY NAME] worksites and facilities.

**3. Policy Statement** — Visitors are protected while on site and must follow site safety rules and remain escorted in work areas.
...
<sub>Template ID: `visitor-safety-policy` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
