# Employee Safety Responsibilities Policy
...
## Policy
**1. Purpose** — Define what the company expects of every employee for safety.

**2. Scope** — All employees of [COMPANY NAME].

**3. Policy Statement** — Each employee shares responsibility for a safe workplace and is expected to actively participate in the safety program.
...
<sub>Template ID: `employee-safety-responsibilities-policy` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
