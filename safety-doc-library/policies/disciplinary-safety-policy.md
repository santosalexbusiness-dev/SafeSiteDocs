...
## Policy
**1. Purpose** — Apply fair, consistent accountability for safety performance.

**2. Scope** — All employees of [COMPANY NAME].

**3. Policy Statement** — Safety rules apply to everyone. The company uses progressive, consistent discipline for violations, while recognizing that reporting hazards and near misses in good faith is encouraged, not punished.
...
<sub>Template ID: `disciplinary-safety-policy` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
