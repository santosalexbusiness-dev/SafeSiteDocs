...
## Policy
**1. Purpose** — Protect workers from heat-related illness.

**2. Scope** — All employees performing work in hot indoor or outdoor environments.

**3. Policy Statement** — The company prevents heat illness through water, rest, shade, acclimatization, training, and monitoring.
...
<sub>Template ID: `heat-illness-prevention-policy` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
