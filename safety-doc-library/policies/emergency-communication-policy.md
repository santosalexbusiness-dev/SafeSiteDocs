...
## Policy
**1. Purpose** — Ensure fast, clear communication during emergencies.

**2. Scope** — All employees and worksites of [COMPANY NAME].

**3. Policy Statement** — The company maintains clear methods to alert, communicate with, and account for employees during an emergency.
...
<sub>Template ID: `emergency-communication-policy` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
