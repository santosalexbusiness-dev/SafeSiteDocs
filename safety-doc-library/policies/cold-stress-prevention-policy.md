...
## Policy
**1. Purpose** — Protect workers from cold-related illness and injury.

**2. Scope** — All employees performing work in cold environments.

**3. Policy Statement** — The company prevents cold stress through clothing, warm-up breaks, monitoring, and training.
...
<sub>Template ID: `cold-stress-prevention-policy` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
