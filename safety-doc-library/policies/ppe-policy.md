...
## Policy
**1. Purpose** — Require selection, use, and maintenance of appropriate PPE.

**2. Scope** — All employees of [COMPANY NAME]; visitors and subs as required.

**3. Policy Statement** — PPE is provided and used based on a hazard assessment, as the last layer of protection after other controls.
...
<sub>Template ID: `ppe-policy` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
