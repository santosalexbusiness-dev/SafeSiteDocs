...
## Policy
**1. Purpose** — Set safety expectations for subcontractors working with the company.

**2. Scope** — All subcontractors performing work for [COMPANY NAME].

**3. Policy Statement** — Subcontractors are expected to work safely, comply with site rules, and maintain their own compliant safety programs and records.
...
<sub>Template ID: `subcontractor-safety-policy` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
