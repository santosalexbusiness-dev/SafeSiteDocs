...
## Policy
**1. Purpose** — Protect workers from lightning, high wind, extreme heat/cold, and storms.

**2. Scope** — All employees at [COMPANY NAME] worksites.

**3. Policy Statement** — Work is adjusted or suspended when severe weather creates an unsafe condition. Worker safety takes priority over schedule.
...
<sub>Template ID: `severe-weather-policy` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
