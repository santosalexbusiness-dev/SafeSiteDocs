...
|---|---|:--:|:--:|:--:|---|
| 1 | WATER: cool, potable water available and close to work |  |  |  |  |
| 2 | WATER: enough for the crew and the full shift; refilled before empty |  |  |  |  |
| 3 | REST: preventive cool-down breaks allowed and encouraged |  |  |  |  |
| 4 | REST: break frequency increased as heat rises |  |  |  |  |
| 5 | SHADE: shade or a cool area accessible to all workers |  |  |  |  |
| 6 | Workers reminded to drink regularly (not just when thirsty) |  |  |  |  |
| 7 | Supervisor monitoring conditions and workers |  |  |  |  |
...
<sub>Template ID: `water-rest-shade-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
