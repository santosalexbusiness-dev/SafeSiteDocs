...
## Plan
**Heat Acclimatization Plan for [COMPANY NAME].** New and returning workers are at higher risk and need to build tolerance gradually.
...
<sub>Template ID: `heat-acclimatization-plan` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
