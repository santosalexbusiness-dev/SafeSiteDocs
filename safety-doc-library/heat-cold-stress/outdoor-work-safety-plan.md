...
## Plan
**Outdoor Work Safety Plan for [COMPANY NAME].** Covers weather-related hazards for outdoor crews.
...
<sub>Template ID: `outdoor-work-safety-plan` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
