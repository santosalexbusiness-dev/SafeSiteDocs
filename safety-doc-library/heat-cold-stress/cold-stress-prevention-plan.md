...
## Plan
**Cold Stress Prevention Plan for [COMPANY NAME].** Customize for your conditions.
...
<sub>Template ID: `cold-stress-prevention-plan` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Pro.</sub>
