...
## Template Body
Document a heat-related illness (also complete the company Incident Report Form). Heat stroke is a 911 emergency.
...
<sub>Template ID: `heat-illness-incident-report` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
