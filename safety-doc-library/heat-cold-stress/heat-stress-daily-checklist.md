...
|---|---|:--:|:--:|:--:|---|
| 1 | Forecast/heat index checked; plan adjusted |  |  |  |  |
| 2 | Cool drinking water stocked and close to the work |  |  |  |  |
| 3 | Shade or a cool rest area available |  |  |  |  |
| 4 | Rest break schedule set for the conditions |  |  |  |  |
| 5 | New/returning workers identified for acclimatization |  |  |  |  |
| 6 | Crew briefed on heat-illness signs and the 911 response for heat stroke |  |  |  |  |
| 7 | Buddy system / supervisor checks in place for high heat |  |  |  |  |
...
<sub>Template ID: `heat-stress-daily-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
