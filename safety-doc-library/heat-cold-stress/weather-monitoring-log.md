...
## Log
Log weather conditions that affect work (heat, cold, wind, storms).
...
<sub>Template ID: `weather-monitoring-log` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
