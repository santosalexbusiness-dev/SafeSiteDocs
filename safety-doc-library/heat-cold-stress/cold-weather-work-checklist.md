...
|---|---|:--:|:--:|:--:|---|
| 1 | Conditions/wind chill checked; plan adjusted |  |  |  |  |
| 2 | Workers dressed in layers; head and hands covered |  |  |  |  |
| 3 | Dry clothing available; plan to stay dry |  |  |  |  |
| 4 | Warm-up breaks and warming area available |  |  |  |  |
| 5 | Warm liquids provided |  |  |  |  |
| 6 | Ice hazards on walkways/ladders/scaffolds treated |  |  |  |  |
| 7 | Crew briefed on hypothermia and frostbite signs |  |  |  |  |
...
<sub>Template ID: `cold-weather-work-checklist` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
