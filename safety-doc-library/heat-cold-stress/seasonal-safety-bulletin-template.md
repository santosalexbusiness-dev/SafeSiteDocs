...
## Template Body
[ Editable one-page bulletin to post or hand out at the start of a season. ]
...
<sub>Template ID: `seasonal-safety-bulletin-template` · Editable master (Markdown). Export to Word/PDF for distribution. Access level: Starter.</sub>
